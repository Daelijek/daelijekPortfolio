export const portfolioContent = {
  en: {
    system: {
      ...
      preloader: {
        initCore: "INITIALIZING_CORE_SYSTEMS",
        syncTypography: "SYNCHRONIZING_TYPOGRAPHY",
        cachingAssets: "CACHING_TEXTURES_AND_ASSETS",
        calibratingShaders: "CALIBRATING_WEBGL_SHADERS",
        ready: "SYSTEM_READY // ALL_CHANNELS_ONLINE",
        loading: "LOADING",
        loaded: "LOADED"
      },
      marquee: [
    ...
    nav: {
      ...
      menuSub: "NAVIGATION",
      systemTitle: "System",
      systemSub: "GLOBAL CONFIG",
      coreTheme: "[01] CORE THEME",
      audioEngine: "[02] AUDIO ENGINE",
      audioDefault: "Default",
      audioDefaultSub: "AMBIENT / LO-FI",
      audioMinimal: "Digital Minimalism",
      audioMinimalSub: "SYNTHWAVE / RETRO",
      perfTier: "[03] PERFORMANCE TIER",
      perfHigh: "High",
      perfMed: "Medium",
      perfSaver: "Saver",
    ...
    about: {
      ...
      experienceTitle: "EXPERIENCE LOGS",
      experienceSubtitle: "Production engineering & startup track record",
      experience: {
    ...
    projects: {
      ...
      otherSubtitle: "Open-source tools, algorithms & prototypes",
      otherProjects: [
    ...
    contact: {
      ...
      quickChannels: "// QUICK_CHANNELS",
      encrypted: "[ENCRYPTED]",
      openTelegram: "OPEN TELEGRAM STREAM",
      ...
      messagePlaceholder: "Describe project scope, timeline, or inquiry...",
      sendButton: "TRANSMIT MESSAGE",
      sendingButton: "TRANSMITTING...",
      messageSent: "MESSAGE_TRANSMITTED_SUCCESSFULLY",
      messageSentDesc: "Thank you for reaching out. Transmission received. I will respond to your channel within 24 hours.",
      sendAnother: "SEND ANOTHER TRANSMISSION",
  ...
  ru: {
    system: {
      ...
      availabilityBadge: "СТАТУС",
      availabilityShort: "ОТКРЫТ",
      status: "СТАБИЛЬНО",
      ...
      preloader: {
        initCore: "ИНИЦИАЛИЗАЦИЯ_СИСТЕМНОГО_ЯДРА",
        syncTypography: "СИНХРОНИЗАЦИЯ_ТИПОГРАФИКИ",
        cachingAssets: "КЭШИРОВАНИЕ_ТЕКСТУР_И_РЕСУРСОВ",
        calibratingShaders: "КАЛИБРОВКА_WEBGL_ШЕЙДЕРОВ",
        ready: "СИСТЕМА_ГОТОВА // ВСЕ_КАНАЛЫ_АКТИВНЫ",
        loading: "ЗАГРУЗКА",
        loaded: "ГОТОВО"
      },
      marquee: [
        { label: "РЕНДЕРИНГ", value: "NEXT.JS 15 / REACT 19" },
        { label: "МОБИЛЬНОЕ_ЯДРО", value: "FLUTTER & RIVERPOD" },
        { label: "КРОССПЛАТФОРМА", value: "REACT NATIVE (EXPO)" },
        { label: "НАПРАВЛЕНИЕ", value: "FRONTEND & MOBILE" },
        { label: "БЭКЕНД", value: "FASTAPI & POSTGRESQL" },
        { label: "СТАТУС", value: "ОТКРЫТ" },
        { label: "МАСШТАБ", value: "TRUSTME (1.5M+ ПОЛЬЗОВАТЕЛЕЙ)" },
        { label: "EDTECH", value: "BEYIMTECH (20+ ШКОЛ)" },
        { label: "БАЗА", value: "АСТАНА (UTC+5)" }
      ],
      wannaSayHello: "Связаться со мной",
    ...
    nav: {
      ...
      menuSub: "НАВИГАЦИЯ",
      systemTitle: "Система",
      systemSub: "ГЛОБАЛЬНЫЕ НАСТРОЙКИ",
      coreTheme: "[01] ОСНОВНАЯ ТЕМА",
      audioEngine: "[02] АУДИО ДВИЖОК",
      audioDefault: "По умолчанию",
      audioDefaultSub: "AMBIENT / LO-FI",
      audioMinimal: "Цифровой минимализм",
      audioMinimalSub: "SYNTHWAVE / RETRO",
      perfTier: "[03] ПРОИЗВОДИТЕЛЬНОСТЬ",
      perfHigh: "Макс",
      perfMed: "Средне",
      perfSaver: "Эконом",
      ...
      sectors: [
        ...
        },
        {
          ...
          skills: [
            ...
            { hex: "0x0E", name: "Supabase" },
            { hex: "0x0F", name: "Node.js & Express" },
            { hex: "0x10", name: "Docker & Контейнеры" },
            { hex: "0x11", name: "REST & GraphQL" }
          ]
        },
        {
          ...
          skills: [
            { hex: "0x12", name: "Интеграция OpenAI API" },
            { hex: "0x13", name: "Lexical Markdown Редакторы" },
            { hex: "0x14", name: "AI Чат-боты в реальном времени" },
            { hex: "0x15", name: "Prompt Engineering" },
            { hex: "0x16", name: "Системы телеметрии" },
            { hex: "0x17", name: "Визуализация данных" }
          ]
        },
        {
          code: "Сектор_05",
          title: "Blockchain & Enterprise",
          skills: [
            { hex: "0x18", name: "TrustMe (1.5M+ Пользователей)" },
            { hex: "0x19", name: "Smart Contract UI" },
            { hex: "0x1A", name: "ЭЦП и SMS-подписание" },
            { hex: "0x1B", name: "Платформа OpenGov.kz" }
          ]
        },
        {
          code: "Сектор_06",
          title: "Интерактивный UI & Анимация",
          skills: [
            { hex: "0x1C", name: "Framer Motion" },
            { hex: "0x1D", name: "Web Audio API Synth" },
            { hex: "0x1E", name: "Canvas 2D / Частицы" },
            { hex: "0x1F", name: "Three.js / WebGL" }
          ]
        },
        {
          code: "Сектор_07",
          title: "Архитектура & Инструменты",
          skills: [
            { hex: "0x20", name: "Git & GitHub" },
            { hex: "0x21", name: "Vite & Turbopack" },
            { hex: "0x22", name: "Vercel Деплой" },
            { hex: "0x23", name: "Figma to Code" }
          ]
        },
        {
          code: "Сектор_08",
          title: "Стейт & Real-Time Синхронизация",
          skills: [
            { hex: "0x24", name: "RTK Query / Redux" },
            { hex: "0x25", name: "Firebase Remote Config" },
            { hex: "0x26", name: "Firebase App Distribution" },
            { hex: "0x27", name: "i18n Мультиязычность" }
          ]
        }
      ],
      experienceTitle: "СИСТЕМНЫЕ ЛОГИ ОПЫТА",
      experienceSubtitle: "Опыт работы в продуктовых компаниях и стартапах",
      experience: {
        tag: "СЕКТОР_03 // КАРЬЕРНАЯ ТЕЛЕМЕТРИЯ",
        title: "СИСТЕМНЫЕ ЛОГИ ОПЫТА",
        subtitle: "Опыт работы в продуктовых компаниях и стартапах",
        logs: [
          {
            code: "LOG_01",
    ...
    projects: {
      ...
      otherTitle: "АРХИВ СИСТЕМЫ И ЭКСПЕРИМЕНТЫ",
      otherSubtitle: "Open-source инструменты, утилиты и прототипы",
      otherProjects: [
      ...
      logs: [
        {
          ...
          tag: "MOBILE & AI",
          status: "PRODUCTION",
          desc: "Умный финансовый трекер с AI-распознаванием чеков и аналитикой трат."
        },
        {
          id: "beyimtech",
          title: "BeyimTech AI Platform",
          ...
          tag: "BEYIM.AI ECOSYSTEM",
          status: "ASTANA HUB RELEASE",
          desc: "Адаптивная AI-система обучения для 20+ школ с телеметрией и аналитикой."
        },
        {
          id: "opengov",
          title: "OpenGov.kz Platform",
          ...
          tag: "WEB & MOBILE UI",
          status: "ENTERPRISE",
          desc: "Государственный веб-портал с высоконагруженным потоком открытых данных."
        },
        {
          id: "berikweb",
          title: "BerikWeb Portfolio",
          ...
          tag: "CREATIVE SAAS",
          status: "SHIPPED",
          desc: "Быстрый мультиязычный персональный брендинг-портал с 3D интерактивностью."
        }
      ]
    },
    contact: {
      ...
      github: "https://github.com/Daelijek",
      linkedin: "https://www.linkedin.com/in/dias-yermek/",
      quickChannels: "// БЫСТРЫЕ_КАНАЛЫ",
      encrypted: "[ЗАШИФРОВАНО]",
      openTelegram: "ОТКРЫТЬ TELEGRAM КАНАЛ",
      copyEmail: "СКОПИРОВАТЬ EMAIL",
      copied: "EMAIL_СКОПИРОВАН_В_БУФЕР",
      formTitle: "// ОТПРАВИТЬ_СООБЩЕНИЕ",
      formReady: "[ГОТОВО]",
      nameLabel: "ВАШЕ_ИМЯ",
      namePlaceholder: "например, Арман Сериков",
      emailLabel: "ВАШ_EMAIL",
      emailPlaceholder: "например, arman@company.com",
      messageLabel: "ТЕКСТ_СООБЩЕНИЯ",
      messagePlaceholder: "Опишите проект, стек, сроки или ваш вопрос...",
      sendButton: "ОТПРАВИТЬ СООБЩЕНИЕ",
      sendingButton: "ОТПРАВКА...",
      messageSent: "СООБЩЕНИЕ_УСПЕШНО_ОТПРАВЛЕНО",
      messageSentDesc: "Спасибо за обращение. Сообщение получено. Я отвечу вам по указанным каналам в течение 24 часов.",
      sendAnother: "ОТПРАВИТЬ ЕЩЕ ОДНО СООБЩЕНИЕ",
      localTimeLabel: "МЕСТНОЕ ВРЕМЯ В АСТАНЕ"
    },
    footer: {
      rights: "ДИАС ЕРМЕК // ВСЕ СИСТЕМЫ В НОРМЕ",
      engine: "РАЗРАБОТАНО НА NEXT.JS 15, TAILWIND И WEB AUDIO API",
      year: "2026",
      wannaSayHello: "Связаться со мной",
      localTime: "Местное время",
      astanaCity: "Астана"
  ...
  kk: {
    system: {
      brandTitle: "ДИАС ЕРМЕК",
      brandSub: "ЖҮЙЕЛІК ПОРТФОЛИО // 2026",
      location: "АСТАНА, ҚАЗАҚСТАН",
      timezone: "UTC+5",
      availability: "ҰСЫНЫСТАРҒА АШЫҚПЫН (FULL-TIME & CONTRACT)",
      availabilityBadge: "МӘРТЕБЕ",
      availabilityShort: "АШЫҚ",
      status: "ТҰРАҚТЫ",
      role: "MIDDLE FRONTEND & MOBILE ӘЗІРЛЕУШІ",
      heroHeadline: "MOBILE & WEB ИНЖЕНЕР",
      heroInfoLog: "[ INFO_LOG ] AI, EDTECH ЖӘНЕ ДЕЦЕНТРАЛИЗАЦИЯЛАНҒАН ЖҮЙЕЛЕРМЕН ЖОҒАРЫ ӨНІМДІ WEB ЖӘНЕ MOBILE ӨНІМДЕРДІ ӘЗІРЛЕУ.",
      ctaPrimary: "ЖОБАЛАРДЫ ҚАРАУ",
      ctaSecondary: "ХАБАРЛАСУ",
      stats: {
        projectsTitle: "АЯҚТАЛҒАН_ЖОБАЛАР",
        projectsCount: "15+",
        projectsProgress: "92%",
        experienceTitle: "ӘЗІРЛЕУ_ТӘЖІРИБЕСІ",
        experienceCount: "3+ жыл",
        experienceProgress: "88%",
        terminalLog: [
          "> ACTIVE_STACK: NEXT15_FLUTTER_REACT_NATIVE",
          "> AVAILABILITY_TYPE: REMOTE / HYBRID / RELOCATE",
      ...
      preloader: {
        initCore: "НЕГІЗГІ_ЖҮЙЕЛЕРДІ_БАПТАУ",
        syncTypography: "ТИПОГРАФИКАНЫ_СИНХРОНДАУ",
        cachingAssets: "РЕСУРСТАРДЫ_КЕШТЕУ",
        calibratingShaders: "WEBGL_ШЕЙДЕРЛЕРІН_КАЛИБРЛЕУ",
        ready: "ЖҮЙЕ_ДАЙЫН // БАРЛЫҚ_АРНАЛАР_ҚОСЫЛДЫ",
        loading: "ЖҮКТЕЛУДЕ",
        loaded: "ДАЙЫН"
      },
      marquee: [
        { label: "РЕНДЕРИНГ", value: "NEXT.JS 15 / REACT 19" },
        { label: "МОБИЛЬДІК_ӨЗЕК", value: "FLUTTER & RIVERPOD" },
        { label: "КРОСС-ПЛАТФОРМА", value: "REACT NATIVE (EXPO)" },
        { label: "БАҒЫТ", value: "FRONTEND & MOBILE" },
        { label: "БЭКЕНД", value: "FASTAPI & POSTGRESQL" },
        { label: "МӘРТЕБЕ", value: "АШЫҚ" },
        { label: "АУҚЫМ", value: "TRUSTME (1.5M+ ПАЙДАЛАНУШЫ)" },
        { label: "EDTECH", value: "BEYIMTECH (20+ МЕКТЕП)" },
        { label: "БАЗА", value: "АСТАНА (UTC+5)" }
      ],
      wannaSayHello: "Хабарласқыңыз келе ме?",
    ...
    nav: {
      ...
      menuSub: "НАВИГАЦИЯ",
      systemTitle: "Жүйе",
      systemSub: "ЖАҺАНДЫҚ БАПТАУЛАР",
      coreTheme: "[01] НЕГІЗГІ ТАҚЫРЫП",
      audioEngine: "[02] АУДИО ҚОЗҒАЛТҚЫШ",
      audioDefault: "Әдепкі",
      audioDefaultSub: "AMBIENT / LO-FI",
      audioMinimal: "Сандық минимализм",
      audioMinimalSub: "SYNTHWAVE / RETRO",
      perfTier: "[03] ӨНІМДІЛІК ДЕҢГЕЙІ",
      perfHigh: "Жоғары",
      perfMed: "Орташа",
      perfSaver: "Үнемдеу",
    ...
    about: {
      ...
      sectorsSubtitle: "Технологиялық секторлар және қолданылатын стек",
      sectors: [
        {
          code: "Сектор_01",
          title: "Web & Frontend Архитектурасы",
          skills: [
            { hex: "0x00", name: "TypeScript" },
            { hex: "0x01", name: "React 19" },
            { hex: "0x02", name: "Next.js 15 (App Router)" },
        ...
        {
          code: "Сектор_03",
          title: "Backend, Дерекқорлар & Cloud",
          skills: [
            { hex: "0x0C", name: "FastAPI (Python)" },
            { hex: "0x0D", name: "PostgreSQL" },
            { hex: "0x0E", name: "Supabase" },
            { hex: "0x0F", name: "Node.js & Express" },
            { hex: "0x10", name: "Docker & Контейнерлер" },
            { hex: "0x11", name: "REST & GraphQL" }
          ]
        },
        {
          code: "Сектор_04",
          title: "AI, Телеметрия & Жүйелер",
          skills: [
            { hex: "0x12", name: "OpenAI API Интеграциясы" },
            { hex: "0x13", name: "Lexical Markdown Редакторлары" },
            { hex: "0x14", name: "Нақты уақыттағы AI чат-боттары" },
            { hex: "0x15", name: "Prompt Engineering" },
            { hex: "0x16", name: "Телеметрия жүйелері" },
            { hex: "0x17", name: "Деректерді визуализациялау" }
          ]
        },
        {
          code: "Сектор_05",
          title: "Blockchain & Enterprise",
          skills: [
            { hex: "0x18", name: "TrustMe (1.5M+ Пайдаланушы)" },
            { hex: "0x19", name: "Smart Contract UI" },
            { hex: "0x1A", name: "ЭЦҚ және SMS-қол қою" },
            { hex: "0x1B", name: "OpenGov.kz Платформасы" }
          ]
        },
        {
          code: "Сектор_06",
          title: "Интерактивті UI & Қозғалыс",
          skills: [
            { hex: "0x1C", name: "Framer Motion" },
            { hex: "0x1D", name: "Web Audio API Synth" },
            { hex: "0x1E", name: "Canvas 2D / Бөлшектер" },
            { hex: "0x1F", name: "Three.js / WebGL" }
          ]
        },
        {
          code: "Сектор_07",
          title: "Архитектура & Құралдар",
          skills: [
            { hex: "0x20", name: "Git & GitHub" },
            { hex: "0x21", name: "Vite & Turbopack" },
            { hex: "0x22", name: "Vercel Деплой" },
        ...
        {
          code: "Сектор_08",
          title: "Күй & Real-Time Синхрондау",
          skills: [
            { hex: "0x24", name: "RTK Query / Redux" },
            { hex: "0x25", name: "Firebase Remote Config" },
            { hex: "0x26", name: "Firebase App Distribution" },
            { hex: "0x27", name: "i18n Көптілділік" }
          ]
        }
      ],
      experienceTitle: "ЖҰМЫС ТӘЖІРИБЕСІНІҢ ЛОГТАРЫ",
      experienceSubtitle: "Өнімдік компаниялар мен стартаптардағы нәтижелер",
      experience: {
        tag: "СЕКТОР_03 // МАНСАП ТЕЛЕМЕТРИЯСЫ",
        title: "ЖҰМЫС ТӘЖІРИБЕСІНІҢ ЛОГТАРЫ",
        subtitle: "Өнімдік компаниялар мен стартаптардағы нәтижелер",
        logs: [
          {
            code: "LOG_01",
    ...
    projects: {
      tag: "СЕКТОР_02 // ЖОБАЛАР КӨРМЕСІ",
      title: "ТАҢДАУЛЫ PRODUCTION ЖОБАЛАР",
      subtitle: "Жылдамдық, эстетика және функционалға бағытталып жасалған",
      liveDemo: "ДЕМО",
    ...
    contact: {
      ...
      github: "https://github.com/Daelijek",
      linkedin: "https://www.linkedin.com/in/dias-yermek/",
      quickChannels: "// ЖЫЛДАМ_АРНАЛАР",
      encrypted: "[ШИФРЛАНҒАН]",
      openTelegram: "TELEGRAM АРНАСЫН АШУ",
      copyEmail: "EMAIL КӨШІРУ",
      copied: "EMAIL_БУФЕРГЕ_КӨШІРІЛДІ",
      formTitle: "// ХАБАРЛАМА_ЖІБЕРУ",
      formReady: "[ДАЙЫН]",
      nameLabel: "СІЗДІҢ_АТЫҢЫЗ",
      namePlaceholder: "мысалы, Арман Серіков",
      emailLabel: "СІЗДІҢ_EMAIL",
      emailPlaceholder: "мысалы, arman@company.com",
      messageLabel: "ХАБАРЛАМА_МӘТІНІ",
      messagePlaceholder: "Жоба көлемін, уақыт шегін немесе сұрағыңызды сипаттаңыз...",
      sendButton: "ХАБАРЛАМАНЫ ЖІБЕРУ",
      sendingButton: "ЖІБЕРІЛУДЕ...",
      messageSent: "ХАБАРЛАМА_СӘТТІ_ЖІБЕРІЛДІ",
      messageSentDesc: "Хабарласқаныңызға рахмет. Хабарлама қабылданды. Мен сізге 24 сағат ішінде жауап беремін.",
      sendAnother: "ТАҒЫ БІР ХАБАРЛАМА ЖІБЕРУ",
      localTimeLabel: "АСТАНАДАҒЫ ЖЕРГІЛІКТІ УАҚЫТ"
    },
    footer: {
      rights: "ДИАС ЕРМЕК // БАРЛЫҚ ЖҮЙЕЛЕР ҚАЛЫПТЫ ЖҰМЫС ІСТЕП ТҰР",
      engine: "NEXT.JS 15, TAILWIND ЖӘНЕ WEB AUDIO API НЕГІЗІНДЕ ЖАСАЛҒАН",
      year: "2026",
      wannaSayHello: "Хабарласқыңыз келе ме?",
      localTime: "Жергілікті уақыт",
      astanaCity: "Астана"
